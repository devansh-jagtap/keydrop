  ...
  useEffect(() => {
    ...
    async function syncUser() {
      try {
        ...
        if (active) {
          setError(err instanceof Error ? err.message : "Unable to finish sign-up");
        }
      }
    }
    ...
    <main style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px", background: "var(--bg)" }}>
      <div style={{ textAlign: "center" }}>
        ...
        {error ? (
          ...
          <p style={{ marginTop: "16px", color: "var(--text-secondary)", fontFamily: "var(--font-sans)" }}>Completing sign-up...</p>
        )}
      </div>
    </main>
  );
